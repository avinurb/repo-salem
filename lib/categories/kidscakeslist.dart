...
class _ProductListkiScreenState extends State<ProductListkiScreen> {
  ...
  List<Map<String, dynamic>> products = [
    ...
    {'name': '  avengners cake', 'price': 1000000, 'rating': 0, 'image': 'assets/avengers.png', 'description': ' کیک کودکانه اونجرز عدد ۷ انگلیسی', 'stock': 3, 'isFavorite': false,'isincart':false},
    {'name': '  barbie cake', 'price': 1300000, 'rating': 0, 'image': 'assets/barbie.png', 'description': 'کیک کودکانه با دیزاین باربی پرینسس ', 'stock': 4, 'isFavorite': false,'isincart':false},
    {'name': '  breaking bad cake', 'price': 950000, 'rating': 0, 'image': 'assets/breakingbad.png', 'description': 'کیک بامزه با طرح سریال بریکینگ بد ', 'stock': 2, 'isFavorite': false,'isincart':false},
    {'name': '  flamingo cake', 'price': 1000000, 'rating': 0, 'image': 'assets/flamingo.jpg', 'description': 'کیک کودکانه تابستانی با دیزاین فلامینگو  ', 'stock': 4, 'isFavorite': false,'isincart':false},
    {'name': '  paw patrols cake', 'price': 1400000, 'rating': 0, 'image': 'assets/pawpatrols.png', 'description': ' کیک کودکانه با دیزاین سگ های نگهبان', 'stock': 3, 'isFavorite': false,'isincart':false},
    {'name': '  pj masks cake', 'price': 1000000, 'rating': 0, 'image': 'assets/pjmasks.png', 'description': ' کیک کودکانه یا طرح پی جی ماسک ها', 'stock': 1, 'isFavorite': false,'isincart':false},
    {'name': '  mini pj masks cake', 'price': 900000, 'rating': 0, 'image': 'assets/pjmasks2.png', 'description': 'کیک کودکانه کوچک با طرح پی جی ماسک ها ', 'stock': 3, 'isFavorite': false,'isincart':false},
    {'name': '  sponge bob cake', 'price': 1000000, 'rating': 0, 'image': 'assets/spongebob.png', 'description': 'کیک کودکانه با طرح باب اسفنجی ', 'stock': 4, 'isFavorite': false,'isincart':false},
    {'name': '  teeth cake', 'price': 800000, 'rating': 0, 'image': 'assets/teeth.png', 'description': ' کیک کودکانه کوچک دندونی', 'stock': 2, 'isFavorite': false,'isincart':false},
    {'name': '  the owl cake', 'price': 1000000, 'rating': 0, 'image': 'assets/the owl.png', 'description': '  کیک کودکانه با طرح جغد رنگارنگ', 'stock': 1, 'isFavorite': false,'isincart':false},
