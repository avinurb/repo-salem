...
void main() {
  ...
  runApp(ProductListcrApp());
}

class ProductListcrApp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      //صفحه اصلی برنامه
      home: ProductListcrScreen(),
    );
  }
}
//از ویجت استست فول استفتده کردم تا پویا باشه و بتونه تغییر کنه
class ProductListcrScreen extends StatefulWidget {
  @override
  //متد کرییت استیت وضعیت صفحه لیست محصولات رو میسازه
  _ProductListcrScreenState createState() => _ProductListcrScreenState();
}

class _ProductListcrScreenState extends State<ProductListcrScreen> {
  ...
  List<Map<String, dynamic>> products = [
    ...
    {'name': 'dunot cake  ', 'price': 800000, 'rating': 0, 'image': 'assets/doughnut.png', 'description': ' کیک خامه ای یک و نیم کیلویی  با  تزیین دوناتی  ', 'stock': 4, 'isFavorite': false,'isincart':false},
    ...
    {'name': '   sweet 16 cake', 'price': 650000, 'rating': 0, 'image': 'assets/crepe.png', 'description': 'کیک نیم کیلویی با تزیین گل خامه ای برای ۱۶ امین سالگرد ازدواج ', 'stock': 4, 'isFavorite': false,'isincart':false},
    {'name': 'flamingo cake   ', 'price': 750000, 'rating': 0, 'image': 'assets/flamingo.jpg', 'description': 'کیک یک و نیم کیلویی بامزه خامه ای با تزیین تابستانی .', 'stock': 5, 'isFavorite': false,'isincart':false},
    {'name': ' pink lemonade cake   ', 'price': 900000, 'rating': 0, 'image': 'assets/pinklemonade.png', 'description': 'کیک ۲ کیلویی خامه ای با دیزاین شاد و تابستانی.', 'stock': 7, 'isFavorite': false,'isincart':false},
    ...
    {'name': '  silver cake ', 'price': 750000, 'rating': 0, 'image': 'assets/silver.png', 'description': 'کیک ساده  ۱ کیلویی با دیزاین طوسی و نقره ای.', 'stock': 3, 'isFavorite': false,'isincart':false},
    {'name': '25 hearts cake  ', 'price': 750000, 'rating': 0, 'image': 'assets/heart.png', 'description': 'کیک جذاب نیم کیلویی با دیزاین قلب های کوچک ', 'stock': 4, 'isFavorite': false,'isincart':false},
    {'name': 'the frog cake   ', 'price': 1050000, 'rating': 0, 'image': 'assets/thefrog.png', 'description': 'کیک ۲ کیلویی خامه ای  بامزه با قورباغه کوچولو', 'stock': 3, 'isFavorite': false,'isincart':false},
    {'name': '  sky love cake ', 'price': 950000, 'rating': 0, 'image': 'assets/sky.png', 'description': 'کیک ۱ کیلویی خامه ای   با طرح آسمان  .', 'stock': 4, 'isFavorite': false,'isincart':false},
